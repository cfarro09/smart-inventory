...
const fields = [
    ...
    /*CAFETERAS*/[
        ...
        { name: 'power', title: 'POTENCIA' },
        { name: 'technology', title: 'TECNOLOGIA' },
        { name: 'pressure_bars', title: 'BARES DE PRESION' },
        { name: 'pump_type', title: 'TIPO DE BOMBA' },
        { name: 'water_tank_capacity', title: 'CAPACIDAD DEL TANQUE DE AGUA' },
        { name: 'milk_tank_capacity', title: 'CAPACIDAD DEL TANQUE DE LECHE' },
        { name: 'milk_feeder', title: 'ALIMENTADOR DE LECHE' },
        { name: 'removable_diffuser', title: 'DIFUSOR REMOVIBLE' },
        { name: 'hot_water_dispenser', title: 'SURTIDOR DE AGUA CALIENTE' },
        { name: 'filter_type', title: 'TIPO DE FILTRO' },
        { name: 'integrated_grinder', title: 'MOLINILLO INTEGRADO' },
        { name: 'grinder_capactiy', title: 'CAPACIDAD DE MOLINILLO' },
        { name: 'recipe_book', title: 'RECETARIO' },
        { name: 'viewer_windows', title: 'VENTANAS VISORAS' },
        { name: 'capacity_n_cups', title: 'CAPACIDAD N TAZAS' },
        { name: 'pitcher', title: 'JARRA' },
        { name: 'pitcher_type', title: 'TIPO DE JARRA' },
        { name: 'removable_filter', title: 'FILTRO REMOVIBLE' },
        { name: 'cleaning_function', title: 'FUNCION DE LIMPIEZA' },
        { name: 'coffee_strength', title: 'INTENSIDAD DE CAFE' },
        { name: 'programmable', title: 'PROGRAMABLE' },
        { name: 'automatic_shutoff', title: 'APAGADO AUTOMATICO' },
        { name: 'freshness_timer', title: 'TEMPORIZADOR DE FRESCURA' },
        { name: 'subcategory', title: 'SUBCATEGORIA' },
        { name: 'model', title: 'MODELO' },
        { name: 'watts', title: 'WATTS' },
        { name: 'finish', title: 'ACABADO' },
